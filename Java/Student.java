/*Create a class student which stores name rollno. and height of a student.Write a program to arrange records of n students in ascending oredr of their height*/
import java.util.*;
class Student
{
	private int roll,ht;
