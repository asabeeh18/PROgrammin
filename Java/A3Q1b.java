/*Q 1.b Create a class Complex which stores real and imaginary parts of a complex number provide the following functions
constructors,add,toString,modulus.*/
import java.util.*;
import java.io.*;
class Complex
{
