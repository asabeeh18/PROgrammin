function checkFileSize(inputFile,compilationstatus) {
    ...
    if (inputFile.files && inputFile.files[0].size > max) {
        alert("File too large. Maximum file size can be 15KB"); 
        inputFile.value = null; // Clear the field.
        return false;
			...
			if (uploadedFile == null || uploadedFile == "") {
				...
				if (!confirmationElement.is(':checked')) {
					alert("Please confirm that the answer submitted is your own");
					 ...
					 responseDiv.html('<img id="loading" src="/CodevitaV4/images/pp.gif" height="10px" style="margin-left:5px;">');
					 $.ajaxFileUpload({
		                url:'/CodevitaV4/subServlet',
		                secureuri:false,
		                    ...
		                    if(typeof(data.error) != 'undefined') {
		                        if(data.error != '') {
		                        	if(data.error == 'session_expired') {	
		                        		responseDiv.html('<img src="/CodevitaV4/images/error.png" style="margin-left:5px;vertical-align: middle;" width="18px">Session Expired');
		                        		alert('Your session has expired, please login and try again.');
										window.open("/CodevitaV4/logout.jsp", "_self");
		                        	}else if(data.error == 'Your contest has ended'){
		                        		responseDiv.html('<img src="/CodevitaV4/images/error.png" style="margin-left:5px;vertical-align: middle;" width="18px">Your contest has ended');
		                        		alert('Your contest has ended. Thank you for your participation.');
										window.open("/CodevitaV4/guidelines.jsp", "_self");
		                        	}else {
			                        	responseDiv.html('<img src="/CodevitaV4/images/error.png" style="margin-left:5px;vertical-align: middle;" width="18px">' + data.error);		                        		
		                        	}
		                        } else {
		                        	/*setTimeout( function() {
											...
											setTimeout( function() {
											responseDiv.html('<img src="/CodevitaV4/images/TickMark.gif" style="margin-left:5px;vertical-align: middle;">' + data.msg);
											alert("95");
											}, 4000);*/					
		                        			responseDiv.html('<img src="/CodevitaV4/images/TickMark.gif" style="margin-left:5px;vertical-align: middle;">' + data.msg +'.<br>Please check    <a href="/CodevitaV4/ChkSubmissionServlet" style="color:blue">My Submissions</a> tab.');	
		                        			//alert("98");
											//setTimeout( function() {getContent('/CodevitaV4/ajaxresult.jsp?problemid='+$('input[name=selected_problem]').val(),responseDiv);},2000);
											//getContent('/CodevitaV4/ajaxresult.jsp',responseDiv);
											/*setTimeout( function() {
		                ...
		                error: function (data, status, e){
		                	...
		                	{responseDiv.html('<img src="/CodevitaV4/images/TickMark.gif" style="margin-left:5px;vertical-align: middle;">Evaluation in progress.<br> Please check <a href="/CodevitaV4/ChkSubmissionServlet" style="color:blue">My Submissions</a> tab after some time.');}
		                	else{
		                	responseDiv.html('<img src="/CodevitaV4/images/error.png" style="margin-left:5px;vertical-align: middle;" width="18px">' +  e);
		                	confirmationElement.removeAttr('checked');
                       	 	$('input[type=file]').val('');
                       	 	$('input[name=fake_file_input]').val('');}
		                }
		...
		function getContent(filename,responseDiv)
                    {
                        $.ajax({
                            ...
                            success: function(data, textStatus, xhr) {
                                  ...
                                  if (filename == '/CodevitaV4/ajaxresult.jsp?problemid='+$('input[name=selected_problem]').val())
                                {
                                    setTimeout( function() {
							...
							'<p id="compatibility_info_heading">' +
								...
								'<ul id="compatibility_info_suggestion_ul">' +						
									'<li>' +
										...
										'<a href="http://www.mozilla.org/en-US/firefox/new/" target="_blank"><img src="/CodevitaV4/images/firefox_icon.gif" style="width: 15px; vertical-align: middle; border: medium none;"></a> or ' + 
										'<a href="https://www.google.com/intl/en/chrome/browser/" target="_blank"><img src="/CodevitaV4/images/chrome_icon.gif" style="width: 15px; vertical-align: middle; border: medium none;"></a>' +
									'</li>' +			  												
								'</ul>' +
								'</div>');
				} 
